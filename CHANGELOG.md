...
- Public `snu-thesis` entrypoint for Typst thesis documents.
- Korean and English rendering controls for body text, cover pages, abstracts, headings, contents, figure/table lists, references, appendices, and acknowledgements.
