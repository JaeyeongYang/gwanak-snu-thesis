...
게시 전 로컬 검증은 [`TESTING.md`](TESTING.md)의 local package mirror workflow를 사용합니다. 공개 예제는 게시 후 사용자와 같은 `@preview` import를 의도적으로 사용합니다.
...
- 검증 명령: [`TESTING.md`](TESTING.md)
- 기여 및 릴리즈 정책: [`CONTRIBUTING.md`](CONTRIBUTING.md)
- 복사해서 바로 쓸 수 있는 예제: `examples/bachelor.typ`, `examples/master.typ`, `examples/phd.typ`
